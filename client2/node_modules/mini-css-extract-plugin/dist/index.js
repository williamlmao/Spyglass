...
class MiniCssExtractPlugin {
  ...
  static getCssModule(webpack) {
    ...
    webpack.util.serialization.register(CssModule, _path.default.resolve(__dirname, "CssModule"), // @ts-ignore
    null, {
  ...
  static getCssDependency(webpack) {
    ...
    webpack.util.serialization.register(CssDependency, _path.default.resolve(__dirname, "CssDependency"), // @ts-ignore
    null, {
      serialize(instance, context) {
        instance.serialize(context);
      },
  ...
  apply(compiler) {
    ...
    compiler.hooks.thisCompilation.tap(pluginName, compilation => {
      ...
      compilation.hooks.contentHash.tap(pluginName, chunk => {
        ...
        chunkGraph.getChunkModulesIterableBySourceType(chunk, _utils.MODULE_TYPE), compilation.runtimeTemplate.requestShortener);
        ...
        if (modules) {
          ...
          chunk.contentHash[_utils.MODULE_TYPE] =
          /** @type {string} */
      ...
      const handler = (chunk, set) => {
        ...
        compilation.addRuntimeModule(chunk, new runtime.GetChunkFilenameRuntimeModule(_utils.MODULE_TYPE, "mini-css", `${RuntimeGlobals.require}.miniCssF`,
        /**
